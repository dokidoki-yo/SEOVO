...
class FeaturePyramid(nn.Module):
    ...
    def forward(self, img):
        cnv2 = self.conv2(self.conv1(img)) # b ,16, 128,160
        cnv4 = self.conv4(self.conv3(cnv2))# b ,32, 64,80
        cnv6 = self.conv6(self.conv5(cnv4))# b ,64, 32,40
        cnv8 = self.conv8(self.conv7(cnv6))# b ,96, 16,20
        cnv10 = self.conv10(self.conv9(cnv8))# b ,128, 8,10
        cnv12 = self.conv12(self.conv11(cnv10))# b ,196, 4,5
        return cnv2, cnv4, cnv6, cnv8, cnv10, cnv12
        # return cnv2, cnv4, cnv6
